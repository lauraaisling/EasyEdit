...
def test_MEND(edit_data_all, editor, hparams, safety_classifier_model, safety_classifier_tokenizer, detoxify_metric, output_dir):
    print("WIP")
    overall_performance = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--editing_hparams_dir', required=True, type=str)  
    ...
    hparams = editing_hparams.from_hparams(args.editing_hparams_dir)
    ...
    if args.editing_method == "DINM":
        ...
        print("WIP")
        train_ds = SafetyDataset(f'{args.data_dir}/SafeEdit_train.json', config=hparams)
        eval_ds = SafetyDataset(f'{args.data_dir}/SafeEdit_eval.json', config=hparams)
        trainer = EditTrainer(
            config=hparams,
            train_set=train_ds,
            val_set=eval_ds
        ...
        overall_performance = test_MEND(edit_data_all, editor, hparams, safety_classifier_model, safety_classifier_tokenizer, detoxify_metric, output_dir)
