...
# test generalisation
python examples/run_safety_editing.py --editing_method=test_gen --edited_model=llama-7b --hparams_dir=./hparams/DINM/llama-7b-wo_bias.yaml --data_path=./data/SafeEdit_kfold/SafeEdit_only_bias.json --safety_classifier_dir=zjunlp/SafeEdit-Safety-Classifier --metrics_save_dir=./safety_results/DINM/gen_wo_bias --ckpt_save_dir=safety_results/models/llama-7b-DINM-only-bias
